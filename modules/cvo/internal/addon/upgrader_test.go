...
func TestAddonInstallStrategyDefaults(t *testing.T) {
	strategy := &cfov1.AddonInstallStrategy{
		Timeout:         &metav1.Duration{Duration: 300000000000},
		RetryCount:      3,
...
func TestAddonDefinitionWithAllFields(t *testing.T) {
	addonDef := cfov1.AddonDefinition{
		Name:        "capi-core-controller",
		Type:        cfov1.AddonTypeHelm,
		Version:     "v1.7.0",
		ContentPath: "charts/capi-core-controller-v1.7.0.tgz",
		Namespace:   "capi-system",
		Dependencies: []string{},
		InstallStrategy: &cfov1.AddonInstallStrategy{
			Timeout:         &metav1.Duration{Duration: 300000000000},
			RetryCount:      3,
			CreateNamespace: true,
			Wait:            true,
		},
		UpgradeStrategy: &cfov1.AddonUpgradeStrategy{
			Type:           "Rolling",
			MaxUnavailable: 0,
			Timeout:        &metav1.Duration{Duration: 300000000000},
			RetryCount:     3,
