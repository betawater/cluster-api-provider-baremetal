...
type ClusterVersionSpec struct {
	...
	DesiredUpdate *commonv1.Update       `json:"desiredUpdate,omitempty"`
}

// ClusterVersionStatus defines the observed state of ClusterVersion.
type ClusterVersionStatus struct {
	ObservedGeneration int64                    `json:"observedGeneration"`
	Desired            commonv1.Release         `json:"desired"`
	ActualVersion      string                   `json:"actualVersion"`
	History            []commonv1.UpdateHistory `json:"history,omitempty"`
	Conditions         []metav1.Condition       `json:"conditions,omitempty"`
	AvailableUpdates   []commonv1.Release       `json:"availableUpdates,omitempty"`
	ComponentStatus    []commonv1.ComponentStatus `json:"componentStatus,omitempty"`
}
